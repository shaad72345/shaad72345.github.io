    ...
    return (
        <Box pt={20} >
            <Flex pt={10} pb={20} flexDirection={['column', 'row', 'row']} justifyContent={'center'} gap={[10, 10, 20]} alignItems={'center'}>
                ...
                <Box>
                    <Heading textAlign={'left'} size={'lg'}> Hi There! <span className="wave" role="img" aria-labelledby="wave">👋🏻</span> </Heading>
                    <Heading textAlign={'left'} mt={2} size={'lg'} id="user-detail-name">I'm Mohammad Shaad </Heading>
                    <TypeWriter />
                    <Flex mt={2}>
